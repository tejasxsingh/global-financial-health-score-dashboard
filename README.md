...
## Data Sources  
We use publicly available indicators from the **World Bank Open Data** portal:  

- [Final Consumption Expenditure (% of GDP)](https://data.worldbank.org/indicator/NE.CON.TOTL.ZS)  
